...
- **Запасы.** Кофе и еда кончаются быстрее всего: их запас лежит на складе наверху, наружная лестница справа от магазина ведёт на площадку, дверь открывается сама. Газировку пополняют из ящика прямо в подсобке — короткий путь вместо долгого. Коробку с полки можно взять в любой момент — и по заданию смены, и заранее, пока очереди нет; если запас полон, полка ничего не отдаст. Передумали — коробка возвращается на место. Витрины пустеют на глазах: по кофейнику, сэндвичам и банкам видно, сколько осталось.
...
- Кнопка «Обучение» в правом верхнем углу показывает шесть иллюстрированных подсказок и расположение рабочих зон.
