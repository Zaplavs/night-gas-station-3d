...
Браузерный 3D-симулятор ночной смены для публикации через GamePush на Пикабу Играх. В проекте есть законченный цикл смены: три заправочных поста, заказы кофе и еды, склад, приёмка топлива, уборка, погода, экономика, репутация, улучшения и семь типов ночных событий.
...
- **Что открывается и когда.** Кофе — с 3-го уровня, дождь — с 4-го, еда — с 6-го, склад — с 7-го, туман — с 9-го, очередь — с 11-го, третий пост — с 12-го, спешащие клиенты — с 13-го, поломки — с 16-го, работа на одной колонке — с 17-го, приёмка топлива — с 18-го, странный фургон — с 19-го, отключения света — с 21-го.
...
`npm test` — быстрая проверка без браузера: ассеты, совпадение разметки с кодом, баланс всех 30 уровней (включая запас топлива под цель и терпение спешащих), таблица достижений и миграция сохранений. Полный сценарий смены прогоняется в headless Chrome:
