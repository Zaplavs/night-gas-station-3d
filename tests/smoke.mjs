...
const required=['index.html','src/main.js','src/gamepush.js','src/content/shifts.js','src/content/progress.js','public/models/station.glb','public/models/pump.glb','public/models/car.glb','public/models/mystery_van.glb','public/models/worker.glb','public/models/bag.glb','public/models/cleaning_kit.glb'];
