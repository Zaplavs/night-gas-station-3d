...
def make_station():
    ...
    # Столб стоит на бетоне, а не парит над ним; щит широкий — на него ложится табличка.
    cube("TankSignPost", (-11.5,.8,-2.4), (.06,.62,.06), M["chrome"], .02)
    cube("TankSign", (-11.5,1.74,-2.4), (.05,.32,.86), M["red"], .04)
    cube("TankSignMark", (-11.58,1.74,-2.4), (.02,.18,.62), M["yellow"], .02)
