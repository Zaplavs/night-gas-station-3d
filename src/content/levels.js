...
const defineLevel = ({
  ...
  orderIntensity = 0,
  orderMenu = [],
  startStock = { coffee: 5, snack: 5, soda: 5 },
  pumpsOnline = 2,
  fuelReserve = null,
  weather = 'clear',
  allowedEvents = [],
  ...
  startStock: Object.freeze({ coffee: startStock.coffee, snack: startStock.snack, soda: startStock.soda ?? 5 }),
  pumpsOnline,
  fuelReserve,
  weather,
...
export const CAMPAIGN_LEVELS = Object.freeze([
  ...
  defineLevel({
    ...
    brief: 'После заправки водитель идёт в магазин за кофе. Аппарат стоит на прилавке — приготовьте стакан и выдайте его на кассе.',
  ...
  defineLevel({
    ...
    brief: 'Полки пустые с самого начала, а на гриле у левой стены пошли хот-доги: их готовят дольше всего.',
  ...
  defineLevel({
    ...
    brief: 'Третий пост закрыт на профилактику, зато в магазине очередь: к тому же в холодильнике появилась газировка, а её запас лежит в подсобке.',
  ...
  defineLevel({
    ...
    startStock: { coffee: 1, snack: 1, soda: 2 }, fuelReserve: 9, weather: 'rain',
  ...
  defineLevel({
    ...
    customerPatience: 42, orderIntensity: 0.75, orderMenu: ['coffee', 'snack', 'hotdog', 'soda'],
    startStock: { coffee: 1, snack: 2, soda: 2 }, fuelReserve: 11, weather: 'rain',
    allowedEvents: ALL_EVENTS, eventSpawn: { initial: [40, 55], interval: [38, 52] },
  ...
  defineLevel({
    ...
    startStock: { coffee: 0, snack: 1, soda: 1 },
  ...
  defineLevel({
    ...
    startStock: { coffee: 1, snack: 1, soda: 2 }, weather: 'fog',
  ...
  defineLevel({
    ...
    startStock: { coffee: 1, snack: 2, soda: 2 }, fuelReserve: 12,
  ...
  defineLevel({
    ...
    startStock: { coffee: 0, snack: 0, soda: 0 }, fuelReserve: 12, weather: 'rain',
