...
const defineLevel = ({
  ...
  customerPatience,
  hurryChance = 0,
  /* Насколько охотно из машины выходят вдвоём: 0 — только водитель. */
  companions = 1,
  fleet = { car: 1 },
  orderIntensity = 0,
  orderMenu = [],
...
export const CAMPAIGN_LEVELS = Object.freeze([
  ...
  defineLevel({
    ...
    brief: 'Снимите пистолет с колонки, заправьте машину и проводите её. Кто-то заодно попросит кофе: аппарат стоит на прилавке в магазине.',
    duration: 170, goal: { served: 4 },
    carSpawn: { initialDelay: 1.2, interval: [17, 22] },
    customerPatience: 62, orderIntensity: 0.45, orderMenu: ['coffee'], companions: 0,
  }),
  defineLevel({
    number: 2, chapter: 1, name: 'Ритм колонки',
    brief: 'Машины пошли чаще, и кофе просят почти в каждой. Колонка и прилавок теперь спорят за вас.',
    duration: 185, goal: { served: 5, rep: 2.8 },
    carSpawn: { initialDelay: 1, interval: [15, 20] },
    customerPatience: 58, orderIntensity: 0.55, orderMenu: ['coffee'], companions: 0.5,
  }),
  defineLevel({
    number: 3, chapter: 1, name: 'Кофе для дальнобойщика',
    brief: 'Из машины выходит не только водитель: бывает, к прилавку встают сразу двое, и ждать они будут каждый своё.',
    duration: 200, goal: { served: 6 },
    carSpawn: { initialDelay: 1, interval: [15, 20] },
    customerPatience: 64, orderIntensity: 0.55, orderMenu: ['coffee'],
  }),
  defineLevel({
    number: 4, chapter: 1, name: 'Дождь над трассой',
    brief: 'Первый дождь за смену: с колёс несут грязь. Пока на полу пятно, за прилавком не обслуживают — швабра важнее кофе.',
  ...
  defineLevel({
    ...
    brief: 'Кофе в аппарате почти нет. Запас всех товаров лежит на складе второго этажа — по наружной лестнице справа.',
  ...
  defineLevel({
    number: 8, chapter: 2, name: 'Гриль и пустые полки',
    brief: 'Полки пустые с самого начала, а на гриле у левой стены пошли хот-доги: их готовят дольше всего, и запас к ним свой.',
    duration: 230, goal: { served: 8, rep: 3 },
    carSpawn: { initialDelay: 1.4, interval: [16, 21] },
    customerPatience: 50, orderIntensity: 0.7, orderMenu: ['coffee', 'snack', 'hotdog'],
  ...
  defineLevel({
    ...
    customerPatience: 46, orderIntensity: 0.7, orderMenu: ['coffee', 'snack', 'hotdog'],
