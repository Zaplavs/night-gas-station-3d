...
class NightStationGame{
  ...
  updateFuelHoseVisual(){
    ...
    const anchor=this.hosePoints[0].set(.62,1.68,0);this.fuelHose.pump.model.localToWorld(anchor);const socket=this.hands.getHoseSocketNDC(this.hoseSocketNdc,this.camera.aspect);if(!socket){this.hoseWorld.visible=false;return}
